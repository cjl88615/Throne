...
OutFile "TaliabuVPN2026v2Setup.exe"
...
!define MUI_WELCOMEPAGE_TITLE "Welcome to TaliabuVPN2026v2 Installer"
!define MUI_WELCOMEPAGE_TEXT "This wizard will guide you through the installation of TaliabuVPN2026v2."
!define MUI_FINISHPAGE_RUN "$INSTDIR\TaliabuVPN2026v2.exe"
!define MUI_FINISHPAGE_RUN_TEXT "Launch TaliabuVPN2026v2"
!addplugindir .\script\
...
UninstallText "This will uninstall TaliabuVPN2026v2. Do you wish to continue?"
...
Function .onInit
  ...
  ${IfNot} ${Errors}
    ...
    ReadRegStr $INSTDIR HKCU "Software\TaliabuVPN2026v2" "TempSetupPath"
    DeleteRegValue HKCU "Software\TaliabuVPN2026v2" "TempSetupPath" ; Clean it up immediately

    SetShellVarContext all
  ${Else}
    ; Normal launch. Default to "Just Me" (Current User)
    StrCpy $IsAllUsers "0"
    StrCpy $INSTDIR "$LOCALAPPDATA\TaliabuVPN2026v2"
...
Function InstallModePageLeave
  ...
  ${If} $0 == ${BST_CHECKED}
    StrCpy $IsAllUsers "1"
    StrCpy $INSTDIR "$PROGRAMFILES64\TaliabuVPN2026v2"
  ${Else}
    StrCpy $IsAllUsers "0"
    StrCpy $INSTDIR "$LOCALAPPDATA\TaliabuVPN2026v2"
  ${EndIf}
...
Function DirectoryLeave
  ${If} $IsAllUsers == "1"
    ...
    ${If} $0 != "Admin"
      ...
      WriteRegStr HKCU "Software\TaliabuVPN2026v2" "TempSetupPath" "$INSTDIR"
...
Section "Install"
  ...
  !insertmacro AbortOnRunningApp "$INSTDIR\TaliabuVPN2026v2.exe"
  ...
  ${If} ${IsNativeAMD64}
    ${If} ${AtLeastWaaS} 1809
      ...
      File /oname=TaliabuVPN2026v2.exe "deployment\windows-amd64\TaliabuVPN2026v2.exe"
    ...
    ${Else}
      ...
      File /oname=TaliabuVPN2026v2.exe "deployment\windowslegacy-amd64\TaliabuVPN2026v2.exe"
  ...
  ${ElseIf} ${IsNativeARM64}
    ...
    File /oname=TaliabuVPN2026v2.exe "deployment\windows-arm64\TaliabuVPN2026v2.exe"
  ...
  ${ElseIf} ${IsNativeIA32}
    ...
    File /oname=TaliabuVPN2026v2.exe "deployment\windowslegacy-386\TaliabuVPN2026v2.exe"
    File /oname=updater.exe "deployment\windowslegacy-386\updater.exe"
  ${Else}
    Abort "Unsupported CPU architecture!"
  ${EndIf}

  CreateShortcut "$DESKTOP\TaliabuVPN2026v2.lnk" "$INSTDIR\TaliabuVPN2026v2.exe"
  CreateShortcut "$SMPROGRAMS\TaliabuVPN2026v2.lnk" "$INSTDIR\TaliabuVPN2026v2.exe" "" "$INSTDIR\TaliabuVPN2026v2.exe" 0

  WriteRegStr SHCTX "Software\TaliabuVPN2026v2" "InstallPath" "$INSTDIR"
  WriteRegStr SHCTX "Software\Microsoft\Windows\CurrentVersion\Uninstall\TaliabuVPN2026v2" "DisplayName" "TaliabuVPN2026v2"
  WriteRegStr SHCTX "Software\Microsoft\Windows\CurrentVersion\Uninstall\TaliabuVPN2026v2" "UninstallString" "$INSTDIR\uninstall.exe"
  WriteRegStr SHCTX "Software\Microsoft\Windows\CurrentVersion\Uninstall\TaliabuVPN2026v2" "InstallLocation" "$INSTDIR"
  WriteRegDWORD SHCTX "Software\Microsoft\Windows\CurrentVersion\Uninstall\TaliabuVPN2026v2" "NoModify" 1
  WriteRegDWORD SHCTX "Software\Microsoft\Windows\CurrentVersion\Uninstall\TaliabuVPN2026v2" "NoRepair" 1
...
Function un.onInit
  ...
  ReadRegStr $0 HKLM "Software\TaliabuVPN2026v2" "InstallPath"
  ...
  ${If} $0 == $UninstPath
    ...
    Pop $1
    ${If} $1 != "Admin"
       MessageBox MB_YESNO|MB_ICONEXCLAMATION "Uninstalling TaliabuVPN2026v2 for all users requires Administrator privileges.$\n$\nDo you want to elevate?" IDNO Stay
...
Section "Uninstall"
  ...
  Delete "$SMPROGRAMS\TaliabuVPN2026v2.lnk"
  Delete "$DESKTOP\TaliabuVPN2026v2.lnk"
  RMDir "$SMPROGRAMS\TaliabuVPN2026v2"

  RMDir /r "$INSTDIR"

  ; Clean up registry!
  DeleteRegKey SHCTX "Software\Microsoft\Windows\CurrentVersion\Uninstall\TaliabuVPN2026v2"
  DeleteRegKey SHCTX "Software\TaliabuVPN2026v2"
SectionEnd
